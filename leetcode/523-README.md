...
assuming nums = [a1, a2, a3, a4, a5, a6, a7, a8]

assuming prefix_sum(a1:a7) = X

assuming prefix_sum(a1:a2) = Y

if (X - Y) % k == 0, we know the following things:

1. sum(a3:a7) % k == 0
2. and sum(a1:a7) % k != 0 because of sum(a1:a2)
3. sum(a1:a2) % k != 0

based on 2 and 3, we can tell

```
sum(a1:a7) % k == sum(a1:a2) % k
```
